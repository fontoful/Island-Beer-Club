...
const History = () => (
    ...
    <Container className='bg-white px-0'>
        ...
        <Image fluid src='/JeffChair.jpg' thumbnail style={{ float: 'left', width: '30%', height: 'auto'}} className=' shadow m-3' />
