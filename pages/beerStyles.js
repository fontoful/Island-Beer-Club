			...
			<Container className='bg-white px-0'>
				...
				<Row className='d-flex flex-column flex-grow-2 w-100'>
					<Col className='d-flex flex-column justify-content-center align-items-center text-dark lead'>
						...
						<Button size='lg' href='http://www.keithandthegirl.com/forums/f6/beer-flowchart-14399/'>CLICK HERE</Button>
				...
				<Row className='d-flex w-100'>
					<Col lg={6} xs={12} className='d-flex flex-column justify-content-center my-4'>
						...
						<h2 className='display-4'>What's an Ale?</h2>
						<p className='lead'>
				...
				<Row className='d-flex flex-row-reverse w-100 my-4'>
					<Col lg={6} xs={12} className='d-flex flex-column justify-content-center my-4'>
						<h2 className='display-4'>What's a Lager?</h2>
						<p className='lead'>
