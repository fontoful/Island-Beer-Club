...
const MemberRegistration = () => {
    ...
    return (
				...
				<form className='member-reg__form' onSubmit={handleSubmit(onSubmit)}>
					...
					<div className='member-reg__row'>
						...
						<div className='error-box'>
							{errors.firstName && <FontAwesomeIcon icon={faExclamationCircle} size='2x' />}
						</div>
							<input
						...
						<div className='member-reg-group-row w-50'>
						<div className='error-box'>
							{errors.lastName && <FontAwesomeIcon icon={faExclamationCircle} size='2x' />}
						...
						<div className='member-reg-group-row w-50'>
						<div className='error-box'>
							{errors.phone && <FontAwesomeIcon icon={faExclamationCircle} size='2x' />}
						</div>
						<MaskedInput
						...
						<div className='member-reg-group-row w-50'>
						<div className='error-box'>
							{errors.email && <FontAwesomeIcon icon={faExclamationCircle} size='2x' />}
						</div>
							<input
								className='member-reg__input'
								type='text'
						...
						<div className='member-reg-group-row w-50'>
						<div className='error-box'>
							{errors.sponsor && <FontAwesomeIcon icon={faExclamationCircle} size='2x' />}
						</div>
							<input
								className='member-reg__input'
								type='text'
		...
		<style jsx global>{`
        html, body {
			background: linear-gradient(90deg, rgba(135,161,171,1) 0%, rgba(69,101,124,1) 87%, rgba(88,125,151,1) 100%);
        }
      `}</style>
        </>
    )
