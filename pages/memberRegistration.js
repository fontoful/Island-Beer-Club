			...
			<Container className='form-container shadow px-0'>
				<Row className='d-flex w-100'>
					<Col className='member-reg-col-one text-light text-center py-4'>
						...
						/>
						<p className='lead'>
							Visit our Profile Page to get an idea what others
							submitted.
						</p>
						<p className='lead'>
							Don’t worry about your Mbr#, your MS date or your
							geneology assignment; they will all be added to your
							profile for you.
						</p>
					</Col>
					...
					<Col md={8} className='member-reg-col-two bg-light'>
						...
						>
							<p className='display-3 mt-5 text-center'>
								{' '}
								Island Beer Club
							</p>
							...
							<div className='member-reg-row pt-4 w-85'>
								<div className='member-reg-group__textarea'>
									<label className='member-reg__label'>
										Bio:
									</label>
									<textarea
