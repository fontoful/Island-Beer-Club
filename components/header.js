import { Jumbotron, Container, Row, Col, Image, Button, OverlayTrigger, Form } from 'react-bootstrap'
		...
		<Container className="text-center">
				...
				<Row>
					<Col>
						...
						<p className="landing-sub-text">Opt-in below for our periodic eGram.</p>
						...
						{['bottom'].map((placement) => (
							...
							>
								<Button variant="light" size="lg">Opt-In</Button>
							</OverlayTrigger>
